...
const AnnouncementNotification = ({
	...
	return (
		<div className="relative" ref={dropdownRef}>
			...
			{/* Dropdown */}
			{showDropdown && (
				<div className="absolute right-0 top-10 w-80 md:w-96 bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-[500px] overflow-hidden flex flex-col">
					{/* Header */}
